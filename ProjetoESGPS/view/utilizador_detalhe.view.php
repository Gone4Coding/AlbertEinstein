...
<div class="col-lg-6">
    ...
    <form action="utilizador_update.php" method="post" class="form-horizontal">
        ...
        <div class='row'>
            <div class="form-group">
                <div<?php echoClassformGroup('username',$msgErros,$dadosSubmetidos);?>>
                    ...
                    <div class="col-lg-8">
                        <input type = "text" id = "idnomePaciente" name = "username" class='form-control' <?php echoFieldValue("username", $utilizador);?>>
                ...
                <div<?php echoClassformGroup('tipo',$msgErros,$dadosSubmetidos);?>>
                    ...
                    <div class="col-lg-8">
                        <label class="radio-inline" for="tipo-0">
                            <input type="radio" name="tipo" id="tipo-0" value="S"  <?php if(getFieldValue('tipo',$utilizador[0]) == 'S'){ echo "checked='.$s.'";}?>>
                            Admnistrativo
                        </label>
                        <label class="radio-inline" for="tipo-1">
                            <input type="radio" name="tipo" id="tipo-1" value="M" <?php if(getFieldValue('tipo',$utilizador[0]) == 'M'){ echo "checked='.$s.'";}?>>
                            Medico
                        </label>
                        <label class="radio-inline" for="tipo-2">
                            <input type="radio" name="tipo" id="tipo-2" value="E" <?php if(getFieldValue('tipo',$utilizador[0]) == 'E'){ echo "checked='.$s.'";}?>>
                            Enfermeiro
                        </label>
                        <label class="radio-inline" for="tipo-3">
                            <input type="radio" name="tipo" id="tipo-3" value="A" <?php if(getFieldValue('tipo',$utilizador[0]) == 'A'){ echo "checked='.$s.'";}?>>
                            Administrador
                        </label>
                    </div>
