...
<div class="col-lg-4"><!-- Formulario -->
    <form action="medicacao_antiga_alterar.php".<?php $_SESSION["num_utente_para_alterar"] = $paciente[0]["num_utente"] ?>
        ...
        <div class="row ">
            ...
            <!-- Data Fim -->
            <?php if(isset($medicamentoUnico[0]["data_fim"])){?>
                <div class="col-xs-12">
                    <label for="data_fim">Data de Fim de Toma</label>
                    <p id="data_fim"
                       class="form-control-static"> <?php echo echoValue("data_fim", $medicamentoUnico[0]) ?> </p>
                </div>
            <?php }?>
            <div class="col-xs-12">
