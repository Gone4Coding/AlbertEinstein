...
<div class="col-lg-4"><!-- Formulario -->
    <h3></h3>
    <form action="medicacao_atual_add.php" .<?php $_SESSION["num_utente_para_alterar"] = $paciente[0]["num_utente"]; ?>
          method="post" class="form-group">
        <div class="row ">
            <!-- Medicamento -->
            <?php if (isset($medicamentoUnico[0]["nome"])) { ?>
                <div class="col-xs-12">
                    <label for="medicamento">Medicamento </label>
                    <p id="medicamento"
                       class="form-control-static"> <?php echo echoValue("nome", $medicamentoUnico[0]) ?> </p>
                </div>
            <?php } ?>
            <div class="col-xs-12">
            ...
            <!-- Data Comeco -->
            <?php if (isset($medicamentoUnico[0]["data_comeco"])) { ?>
                <div class="col-xs-12">
                    <label for="data_comeco">Data de Início de Toma</label>
                    <p id="data_comeco"
                       class="form-control-static"> <?php echo echoValue("data_comeco", $medicamentoUnico[0]) ?> </p>
                </div>
            <?php } ?>
            <div class="col-xs-12">
            ...
            <!-- Motivo -->
            <?php if (isset($medicamentoUnico[0]["motivo"])) { ?>
                <div class="col-xs-12">
                    <label for="motivo">Motivo</label>
                    <p id="motivo"
                       class="form-control-static"> <?php echo echoValue("motivo", $medicamentoUnico[0]) ?> </p>
                </div>
            <?php } ?>
            <div class="col-xs-12">
...
<div class="col-lg-5 ScrollStyle"><!-- Scroll MedsAtuais -->
    <h3></h3>
    <table class="table table-striped">
        ...
        if (isset($medicamentosPaciente)) {
            foreach ($medicamentosPaciente as $linha) {
                echo "\n<tr>";
                echo '<td><a class="btn btn-info" href="medicacao_atual_alterar.php?num_utente=' . $linha["num_utente"] . '&idMedAtual=' . $linha["idMedAtual"] . '" role="button">Ver</a></td>';
                echo "<td>" . $linha["data_começo"] . "</td>";
